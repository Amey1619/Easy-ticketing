...
export class TicketController {
  ...
  public getTicketById = async (
    ...
    try {
      ...
      const ticket = await this.ticket.getTicketById(ticketId, req.body);
      res
        .status(200)
  ...
  public updateTicket = async (
    ...
    try {
      ...
      const updatedTicket = await this.ticket.updateTicketById(
        ticketId,
        updateData,
        req.user
      );
  ...
  public getClaimedTickets = async (
    ...
    try {
      const ticketsData: Ticket[] = await this.ticket.findTickets(req.body);
  ...
  public reassignTicket = async (
    ...
    try {
      ...
      const ticket = await this.ticket.changeAgent(
        ticketId,
        newAgentId,
        req.user
      );
  ...
  public addComment = async (
    ...
    try {
      ...
      const ticket = await this.ticket.createComment(
        ticketId,
        comment,
        req.user
      );
  ...
  public getCommentsById = async (
    ...
    try {
      const ticketId = req.params.id;
      const comments = await this.ticket.getComments(ticketId, req.body);
  ...
  public deleteTicket = async (
    ...
    try {
      const ticketId = req.params.id;
      const ticket = await this.ticket.findAndDeleteTicket(ticketId, req.body);
  ...
  public getTicketLogs = async (
    ...
    try {
      const ticketId = req.params.id;
      const history = await this.ticket.getLogs(ticketId, req.body);
